...
export function Table({
  ...
  registerAction(
    'setNextPageBlock',
    async function (paginationNextPageBlocked) {
      setPaginationNextPageBlocked(paginationNextPageBlocked);
    },
  );
  ...
  const [paginationNextPageBlocked, setPaginationNextPageBlocked] = useState(false);
              ...
              <div className="col">
                {(clientSidePagination || serverSidePagination) && (
                  <Pagination
                    ...
                    blockNextPage={paginationNextPageBlocked}
